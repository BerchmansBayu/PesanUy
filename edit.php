...
<link rel="stylesheet" href="./css/dashboard.css">
  ...
  <main class="main">
   ...
   <div class="card_container">
	...
	include 'koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($koneksi,"select * from tb_bus where id_bus='$id'");
	while($row = mysqli_fetch_array($data)){
        ...
        <tr>			
				<td>Kode Bus</td>
				<td><input type="text" name="kode_bus" value="<?= $row['kode_bus'];?>">
                <input type="hidden" name="id_bus" value="<?= $row['id_bus'];?>">
            </td>
			</tr>
			<tr>			
				<td>Nama Bus</td>
				<td><input type="text" name="nama_bus" value="<?= $row['nama_bus'];?>"></td>
			</tr>
			<tr>
				<td>Kelas Bus</td>
				<td><input type="text" name="kelas_bus" value="<?= $row['kelas_bus'];?>"></td>
			</tr>
			<tr>
				<td>Jumlah Kursi</td>
				<td><input type="text" name="jumlah_kursi" value="<?= $row['jumlah_kursi'];?>"></td>
			</tr>
			<tr>
				<td></td>
